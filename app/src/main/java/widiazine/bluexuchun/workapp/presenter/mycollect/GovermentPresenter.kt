...
class GovermentPresenter(val view:GovermentContract.View):GovermentContract.Presenter{
    val goverListItems = mutableListOf<GovermentModel>()
    override fun loadGover(type: String) {
        goverListItems.clear()
        doAsync {
            val testList = mutableListOf<GovermentModel>(
